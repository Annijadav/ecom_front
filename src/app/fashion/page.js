...
export default function Fashionpage() {
  ...
  return (
    <main className="min-h-screen bg-white text-black relative pt-35">
      {/* Header */}
      <div className="relative px-1 py-4 bg-white z-30">
        ...
        <div className="flex flex-col items-center">
          <h1 className={`text-4xl font-bold ${volkhov.className} text-center`}>Fashion</h1>
          <div className="mt-2">
            <Breadcrumb>
              <BreadcrumbList>
                <BreadcrumbItem>
  ...
  <div className="absolute top-full right-0 z-50 px-1 mt-2">
    <div
      ref={filterRef}
      className="rounded    inline-block min-w-[300px] p-2"
    >
      <SidebarFilters />
    </div>
  </div>
      ...
      {/* Main Layout */}
      <div className="flex flex-col lg:flex-row max-w-[1368px] mx-auto px-4 py-4 gap-8 relative z-10">
        {/* Sidebar on Desktop */}
