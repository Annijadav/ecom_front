  ...
  return (
    <div className="min-h-[420px] bg-gradient-to-br from-gray-50 to-gray-200 py-6 px-2 sm:px-4">
      <div className="max-w-6xl mx-auto rounded-2xl p-3 sm:p-4 lg:p-8">
        <h2
          className={`${volkhov.className} text-xl sm:text-2xl lg:text-4xl font-bold text-center text-gray-800 mb-3 sm:mb-4`}
        >
        ...
        <p className="text-center text-gray-500 max-w-md sm:max-w-xl lg:max-w-5xl mx-auto mb-4 sm:mb-6 text-xs sm:text-sm lg:text-base">
          We love hearing from you! Our customers are at the heart of everything we do, and your
          feedback inspires us to keep getting better. Read real reviews from happy shoppers who
          have loved our products and service. Have something to share? Drop your review and join
          our growing community of satisfied customers!
        </p>
            ...
            return (
              <div
                ...
                className={`absolute top-1/2 -translate-y-1/2 transition-all duration-500 ease-in-out
                  ${
                    position === "active"
                      ? "opacity-100 z-10 scale-100 translate-x-0 shadow-xl w-[280px] sm:w-[min(864px,90vw)]"
                      : ""
                  }
                  ${
                    position === "next"
                      ? "max-[425px]:hidden opacity-60 z-0 scale-95 translate-x-[60%] sm:translate-x-[45%] lg:translate-x-[35%] shadow-md w-0 sm:w-[min(648px,75vw)]"
                      : ""
                  }
                  ${
                    position === "prev"
              ...
              >
                ...
                <div className="bg-white p-4 sm:p-5 lg:p-6 rounded-lg flex flex-row gap-4 md:gap-6 items-center border border-gray-200 h-auto min-h-[156px] sm:min-h-[202px] lg:min-h-[220px]">
                  {/* Image container - fixed positioning */}
                  <div className="reviews_img_shadow bg-red-200 overflow-hidden flex-shrink-0 shadow-lg w-[70.38px] h-[70.38px] sm:w-[202px] sm:h-[202px]">
                    <img
                      src={slide.image}
                      alt={slide.name}
