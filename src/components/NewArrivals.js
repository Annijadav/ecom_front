...
export default function NewArrivals() {
  ...
  }, [activeCategory, fetchNewArrivals, setActiveTag]);
  ...
  return (
    <div className="max-w-[1277px] mx-auto px-3 sm:px-4 lg:px-6 py-8 sm:py-10 lg:py-12">
      ...
      <div className="text-center mb-8 sm:mb-10 lg:mb-12">
        <h2
          className={`${volkhov.className} text-[30px] sm:text-3xl lg:text-4xl font-bold text-gray-800 mb-4 sm:mb-6`}
        >
          New Arrivals
        </h2>
        <p className="text-sm sm:text-base text-gray-600 max-w-4xl mx-auto leading-relaxed px-2">
          Discover the freshest additions to our collection in our New Arrivals section! From the
          latest trends to tretess essentials, we&apos;ve handpicked the newest styles just for you.
          Whether Whether you&apos;re looking to upgrade your wardrobe, ratrash your space, or find
          the perfect gift, our latest arrivals have something for everyone. Don&apos;t miss
          out-explore what&apos;s new and be the first to ews what&apos;s hot this season
        </p>
      </div>
                    ...
                    <button
                      onClick={(e) => {
                        ...
                        const message = `Hi, I want to buy this product from *New Arrivals*:\n🛍️ *Name:* ${
                          product.name
                        }\n🔗 *Link:* ${productURL}\n💰 *Price:* ₹${product.base_price?.toFixed(
                          2
                        )}`;
