          ...
          <div className="flex flex-row lg:flex-row gap-2 sm:gap-4 md:gap-6 justify-center items-center">
            ...
            <div className="flex flex-col justify-between w-[30%] min-h-[197.7px] aspect-[2/2.5] max-w-[120px] sm:max-w-[140px] md:max-w-[200px] lg:w-[30%] lg:max-w-none lg:aspect-[2/3] lg:min-h-0">
              ...
              <div className="relative w-full h-[25%] rounded-lg overflow-hidden mb-1 sm:mb-2 lg:aspect-[4/1] lg:h-auto lg:mb-4 lg:rounded-xl">
                <Image src="/images/images (1).png" alt="Top Image" fill className="object-cover" />
              </div>

              {/* Sale Text */}
              <div className="flex-1 flex flex-col justify-center items-center text-center px-1 lg:py-6">
                <h2 className="text-[15px] sm:text-xs md:text-sm lg:text-4xl xl:text-5xl font-bold text_colar2 leading-tight">
                  ULTIMATE
                </h2>
                <h1 className="text-[22px] sm:text-sm md:text-base lg:text-6xl xl:text-7xl 2xl:text-8xl font-extrabold text-transparent stroke-text leading-tight">
                  SALE
                </h1>
                <p className="text-[5px] sm:text-[8px] md:text-[10px] lg:text-sm tracking-widest text-gray-500 mt-1 mb-1 lg:mt-2 lg:mb-4">
                  NEW COLLECTION
                </p>
                <Link href="/fashion">
                  <button className="bg-yellow-400 hover:bg-yellow-500 text-black cursor-pointer font-semibold py-[2px] px-1 text-[6px] sm:text-[8px] md:text-[10px] lg:py-2 lg:px-6 lg:text-base xl:text-lg rounded-md lg:rounded-xl shadow-md">
                    SHOP NOW
                  </button>
                </Link>
              </div>
