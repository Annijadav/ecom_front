    ...
    <div className="bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-8">
          <h2
            className={`text-[24px] sm:text-4xl md:text-5xl font-bold text-gray-800 mb-4 ${volkhov.className}`}
          >
            Follow Us On Instagram
          </h2>
          <p className="text-gray-600 text-sm sm:text-base max-w-3xl mx-auto leading-relaxed">
            Stay connected and be the first to see our exclusive deals, behind-the-scenes moments!
            Join our Instagram family for daily style inspiration, product highlights, and special
            giveaways. Hit follow & never miss an update — your next favorite find is just a scroll
            away!
          </p>
        </div>
